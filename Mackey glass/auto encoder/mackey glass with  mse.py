# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 23:14:14 2019
...
import pandas as pd
dataset_train = pd.read_csv('mgdata.dat.csv')

training_set = dataset_train.iloc[:1100, 1:2].values
test_set=dataset_train.iloc[1100:1160, 1:2].values
